...
mv ranking_analysis.json ../vega/data/ranking_analysis.json
...
aws s3 cp ../vega/data/ranking_analysis.json s3://www.markmoog.com/vega/data/ranking_analysis.json

echo "Invalidating old files on CloudFront"
aws cloudfront create-invalidation --distribution-id E2QBM02Z5J7Y5V --paths /documents/ratings.html /documents/win_trees.html /documents/ranking_analysis.html /trees/edges2018.json /ratings/ratings_2018.csv /vega/data/ranking_analysis.json
